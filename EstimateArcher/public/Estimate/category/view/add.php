...
<div class="page-content fade-in-up">
            ...
            <div class="ibox">
                <div class="ibox-head">
                    ...
                    ?>
                      ...
                      <button class="btn btn-success text-white" onClick="document.getElementById('view').value='savepatient';document.getElementById('viewpage').value='savepatient';document.myform.submit() "> addSubmit</button>
 ...
 <div class="row">
        <div class="col-sm-3 form-group">
            ...
            <input class="form-control" type="height" name="height" id="height" value="<?= isset($height) ? $height : '' ?>" placeholder="Patient Height">

        </div>
        <div class="col-sm-3 form-group">
           <label for="email">Weight</label>
            <input class="form-control" type="weight" name="weight" id="weight" value="<?= isset($weight) ? $weight : '' ?>" placeholder="Patient Weight">
