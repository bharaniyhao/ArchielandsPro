...
?> -->
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">managecate</li>
    </ol>
</div>
            ...
            <div class="pagination-tab pt-3 pb-3">
                ...
                <div class="table-title d-flex">
                    ...
                    <!-- <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('target').value='addcat'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> New category </button>
                    </div> -->
			...
			if($paging->total_rows > 0){
             ...
             foreach ($rs as $val){
				// $brchname = $engine->getBranch($val['USR_BRCHID']); {
                    ...
                    } elseif ($val['CAT_STATUS'] == 2) {
                        $status_name = 'Pending';
                        $status_color = 'info';
                    } elseif ($val['CAT_STATUS'] == 0) {
                        $status_name = 'Disable';
                        $status_color = 'danger';
                    }
                    echo '<tr>
                        ...
                        <td>'.$val['CAT_DESC'].' </td>
                        <td>'.$val['CAT_PRIC'].'</td>
                        <td>'.$val['CAT_NUM_ROOM'].'</td>
                        <td><span class="badge badge-' . $status_color . '">' . $status_name . '</span></td>
                        <td>
                            <div align="center">
                            

<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="View" onclick="document.getElementById(\'keys\').value = \'' . $val['CAT_CODE'] . '\';document.getElementById(\'target\').value = \'details\';document.getElementById(\'viewpage\').value = \'editcat\';"> <i class="fa fa-eye"></i> View Details
                                </button>
