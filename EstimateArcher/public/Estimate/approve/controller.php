...
$query = "SELECT * FROM Estimate WHERE Estimatestatus IN ( '2') ORDER BY id DESC";
	$input = array();
} else {

	$query = "SELECT * FROM Estimate WHERE Estimatestatus IN ('2') AND ( CustomerName LIKE " . $sql->Param('a') . " OR invoiceNumber LIKE " . $sql->Param('b')  . " ) ORDER BY id  DESC";
