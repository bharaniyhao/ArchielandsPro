...
" data-toggle="tooltip" data-original-title="Payment" onclick="document.getElementById(\'keys\').value = \'' .
                                            $val["BK_CODE"] .
                                            '\';document.getElementById(\'view\').value = \'payment\';document.getElementById(\'viewpage\').value = \'payment\';">
                                    <i class="fa fa-money"></i> Paid
                                </button>

<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['BK_CODE'] . '\';document.getElementById(\'target\').value = \'details\';document.getElementById(\'viewpage\').value = \'bookdetails\';"> <i class="fa fa-eye"></i> Book Details
                                </button>
