...
<div class="page-content fade-in-up">
  ...
  <div class="row justify-content-center">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
        <input type="number" class="form-control" name="$phonenumber" id="$phonenumber" value="<?= isset($phonenumber) ? $phonenumber : '' ?>" readonly>
            </div>
            </div>
            <div class="form-group row">
    ...
    <div class="col-sm-6">
        ...
        <div class="col-sm-6">
                ...
                <div class="form-group row">
        <label for="systemuser" class="col-sm-2 col-form-label"> Login User </label>
        <div class="col-sm-6">
                <input type="text" class="form-control" name="systemuser" id="systemuser" value="<?= isset($systemuser) ? $systemuser : '' ?>" readonly>
            </div>
            </div>
