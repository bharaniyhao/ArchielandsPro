...
<!-- ?> -->
    ...
    <h1 class="page-title">Approved Book List </h1>
    <ol class="breadcrumb">
                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-1">
                     ...
                     <!-- <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('target').value='assess'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> New Assessment </button>
                    </div>  -->
            ...
            if($paging->total_rows > 0){
             ...
             foreach ($rs as $val){
                // $brchname = $engine->getBranch($val['USR_BRCHID']); {
                    ...
                    } elseif ($val['BK_STATUS'] == 2) {
                        $status_name = 'Booked';
                        $status_color = 'info';
                    } elseif ($val['BK_STATUS'] == 3) {
                        $status_name = 'Refunded';
                        $status_color = 'warning';
                    }elseif ($val['BK_STATUS'] == 4) {
                    ...
                    echo '<tr>
                        ...
                        <td>'.$val['BK_AMOUNT'].' </td>
                        <td>'.$val['BK_GUESTNO'].'</td>
                        <td>'.$val['BK_CHECKIN'].'</td>
                        <td>'.$val['BK_CHEKOUT'].'</td>
                        <td>'.$val['BK_CLIENT_LASTNAME'].' '.$val['BK_CLIENT_FIRSTNAME'].'</td>
...
<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['BK_CODE'] . '\';document.getElementById(\'target\').value = \'details\';document.getElementById(\'viewpage\').value = \'editpatient\';"> <i class="fa fa-eye"></i> Book Details
                                </button>
                            </div>
                        </td>';
                }
