...
<div class="page-heading">
    <h1 class="page-title"><?php echo empty($keys) ? 'New' : 'Edit'; ?> Facilities </h1>
    <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Facilities Details</div>
                        <?php 
                    ?>
                       <nav aria-label="breadcrumb">
        <button class="btn btn-success text-white" onClick="document.getElementById('target').value='';document.getElementById('viewpage').value='savefacility';document.myform.submit()">Add Facility</button>
