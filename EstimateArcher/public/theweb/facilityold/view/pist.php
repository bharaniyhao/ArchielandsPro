                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter Therapists Name to Search" />
                    ...
                    <div class="col-sm-3 pagination-right">
                       <!--  <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('view').value='pist'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> Add User </button>
                    </div> -->
...
<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['THERAPIST_ID'] . '\';document.getElementById(\'view\').value = \'details\';document.getElementById(\'viewpage\').value = \'edittherapist\';"> <i class="fa fa-eye"></i> View Details
                              </button>
                            </div>
                        </td>';
                }
