...
<header class="header clf">
    <div class="page-brand"><a class="link" href="index.php?pg=dashboard"><span class="brand"><span class="brand-tip">ARCHER-GROUP</span></span><span class="brand-mini">AG</span></a></div>
    ...
    <ul class="nav pull-right navbar-toolbar">
            ...
            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                ...
                <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                    <div><a class="list-group-item">
                            <div class="media">
                                <div class="media-img"><img class="img-circle" src="./media/assets/img/users/yao.jpeg" />
                                </div>
        ...
        <li class="dropdown dropdown-user"><a class="nav-link dropdown-toggle link" data-toggle="dropdown"><span><?= $session->get('loginuserfulname'); ?></span><img src="./media/assets/img/users/yao.jpeg"></a>
