...
$query = "SELECT * FROM Estimate WHERE Estimatestatus IN ( '1') ORDER BY id DESC";
	$input = array();
} else {

	$query = "SELECT * FROM Estimate WHERE Estimatestatus IN ('1') AND ( CustomerName LIKE " . $sql->Param('a') . " OR invoiceNumber LIKE " . $sql->Param('b')  . " ) ORDER BY id  DESC";
