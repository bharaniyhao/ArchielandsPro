...
<!-- ?> -->
    ...
    <h1 class="page-title"> Objective List </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?pg=dashboard">Home</a></li>
        <li class="breadcrumb-item active">Patient Objective</li>
    </ol>
</div>
                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-1">
                     ...
                     <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('view').value='assess'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> New Assessment </button>
                    </div> 
             ...
             foreach ($rs as $val){
                // $brchname = $engine->getBranch($val['USR_BRCHID']); {
                    ...
                    echo '<tr>
                        <td>'.$num++.'</td>
                        <td>'.$val['PatientID'].'</td>
                        <td>'.$val['FirstName'].' '.$val['OtherName'].'</td>
...
<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['PatientID'] . '\';document.getElementById(\'view\').value = \'details\';document.getElementById(\'viewpage\').value = \'editpatient\';"> <i class="fa fa-eye"></i> Assessment Details
                                </button>
                            </div>
                        </td>';
                }
