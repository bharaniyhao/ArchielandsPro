...
?>
    ...
    <h1 class="page-title">Monitoring/Evaluation  </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?pg=dashboard">Home</a></li>
        <li class="breadcrumb-item active">Monitoring/Evaluation</li>
    </ol>
</div>
            ...
            <div class="pagination-tab pt-3 pb-3">
                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('view').value='financial'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> Generate Invoice </button>
                    </div>-->
             ...
             foreach ($rs as $val){
				// $brchname = $engine->getBranch($val['USR_BRCHID']); {
                    ...
                    echo '<tr>
                        ...
                        <td>
                            <div align="center">
                                <button type="submit" class="btn btn-info text-white" role="button" onClick="document.getElementById(\'target\').value=\'editmember\';document.getElementById(\'viewpage\').value=\'editmember\';document.getElementById(\'keys\').value=\''.$val['PatientID'].'\';document.myform.submit()">
                                    <i class="fa fa-eye"></i> View Details
                                </button>
                                <button type="submit" class="btn btn-danger text-white" role="button" onClick="document.getElementById(\'target\').value=\'editmember\';document.getElementById(\'viewpage\').value=\'editmember\';document.getElementById(\'keys\').value=\''.$val['PatientID'].'\';document.myform.submit()">
