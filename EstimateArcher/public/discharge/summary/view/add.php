...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-sm-3 form-group">
            ...
            <input class="form-control" type="text" name="firstname" id="firstname" value="<?= isset($PatientID) ? $PatientID : '' ?>" placeholder="First Name">
        </div>
        <div class="col-sm-3 form-group">
            <label for="lastname">Patient Full Name</label>
