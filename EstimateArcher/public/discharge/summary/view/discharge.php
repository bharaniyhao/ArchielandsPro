...
?>
    ...
    <h1 class="page-title">Discharge summary List </h1>
    <ol class="breadcrumb">
             ...
             <div class="pagination-tab pt-3 pb-3">
                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('view').value='discharge'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> Discharge Patient </button>  </div>
...
<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['PatientID'] . '\';document.getElementById(\'view\').value = \'details\';document.getElementById(\'viewpage\').value = \'editdischarge\';"> <i class="fa fa-eye"></i> View Details
                                </button>
                            </div>
                        </td>';
                }
