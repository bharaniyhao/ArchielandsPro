...
<div class="page-heading">
    <h1 class="page-title"><?php echo empty($keys) ? 'New' : 'Edit'; ?> Discharge </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?pg=dashboard"> Home </a></li>
        <li class="breadcrumb-item active"><?php echo empty($keys) ? 'Add' : 'Edit'; ?> discharge </li>
    </ol>
</div>
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Discharge Patient Info</div>
                        <?php 
                    ?>
    ...
    <div class="row">
        <div class="col-sm-3 form-group">
            ...
            <input class="form-control" type="text" name="firstname" id="firstname" value="<?= isset($PatientID) ? $PatientID : '' ?>" placeholder=" Patient ID">
        </div>
        <div class="col-sm-3 form-group">
    ...
    <div class="form-group" id="showup">
         <!-- <button class="btn btn-default" type="button" onclick="console.log('Button yao clicked!');showConfirmationAlert('warning', 'Are you sure you want to save New Patient?', 'Save Patient' , 'btn-success' ,'Yes' ,function(){ document.getElementById('view').value='' ;document.getElementById('viewpage').value='savepatient';document.myform.submit(); })">Submit</button>  -->
          ...
          <button class="btn btn-success text-white" onClick="document.getElementById('view').value='';document.getElementById('viewpage').value='Savedischarge';document.myform.submit() ">Submit</button>
    </div>
        </form>
  </div>
            </div>
