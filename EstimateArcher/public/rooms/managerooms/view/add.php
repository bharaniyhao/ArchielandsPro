...
<div class="page-heading">
    <h1 class="page-title"><?php echo empty($keys) ? 'New' : 'Edit'; ?> Room </h1>
    <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <button class="btn btn-success text-white" onClick="document.getElementById('view').value='';document.getElementById('viewpage').value='saverooset';document.myform.submit()">Add Rooms  </button>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-sm-9">
        <select class="form-control selectpicker" data-live-search="true" name="CatID" id="CatID">
    ...
    <div class="col-sm-9">
        <select class="form-control selectpicker" data-live-search="true" name="descr" id="descr" placeholder="Select Category Descriptions">
    ...
    <div class="col-sm-9">
        ...
        <div class="col-sm-9">
        <input type="Publish"  class="form-control" name="addby" id="addby" value="<= isset($addby) ? $addby : '' ?>"  required>
            </div>
            </div> -->
