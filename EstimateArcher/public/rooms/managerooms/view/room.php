                     ...
                     <div class="table-title d-flex">
                         ...
                         <div class="col-sm-5">
                             <div class="input-group">
                                 <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter Rooms ID or Name to Search" />
...
<button type="submit" class="btn btn-default btn-sm btn-primary" data-toggle="tooltip" data-original-title="Room" onclick="document.getElementById(\'keys\').value = \'' .
                                            $val["RoomID"] .
                                            '\';document.getElementById(\'target\').value = \'details\';document.getElementById(\'viewpage\').value = \'details\';"> <i class="fa fa-calender"></i> Update Room </button>

<button type="submit" class="btn btn-default btn-sm btn-danger
" data-toggle="tooltip" data-original-title="Delete" onclick="document.getElementById(\'keys\').value = \'' .
                                            $val["RoomID"] .
                                            '\';document.getElementById(\'view\').value = \'detail\';document.getElementById(\'viewpage\').value = \'detail\';">
