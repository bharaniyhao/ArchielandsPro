...
<div class="page-heading">
    <h1 class="page-title"><?php echo empty($keys) ? 'View' : 'Appointments'; ?>  Details </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?pg=dashboard"> Home </a></li>
        <li class="breadcrumb-item active"><?php echo empty($keys) ? 'Add' : 'Edit'; ?> Room </li>
    </ol>
</div>
...
<!-- 
  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <select class="form-control" id="therapistsId" readonly value="<?= isset($therapistsId) ? $therapistsId : '' ?>"name="therapistsId" readonly>
    ...
    <select class="form-control" id="appointmentType"  value="<?= isset($appointmentType) ? $appointmentType : '' ?>" name="appointmentType" readonly>
        ...
        <option value="follow_up">Follow-up</option>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="date" class="form-control" value="<?= isset($appointmentDate) ? $appointmentDate : '' ?>" id="appointmentDate" name="appointmentDate" readonly>
          </div>
        

         <div class="form-group col-md-6">
    <label for="duration">Duration (HH:MM)</label>
    <input type="time" class="form-control" id="duration" value="<?= isset($duration) ? $duration : '' ?>"name="duration" readonly>
</div>
</div>
        <div class="form-group">
          <label for="message">Reason for Appointment</label>
          <textarea class="form-control" id="message" value="<?= isset($appointmentReason) ? $appointmentReason : '' ?>"name="message" rows="3" placeholder="Enter reason for appointment" readonly></textarea>
        </div>
    <hr />
  </div>
            </div>
