<div class="page-heading">
    <h1 class="page-title"><?php echo empty($keys) ? 'New' : 'Edit'; ?> Physiotherapy  </h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?pg=dashboard"> Home </a></li>
        <li class="breadcrumb-item active"><?php echo empty($keys) ? 'Add' : 'Edit'; ?> Therapy </li>
    </ol>
</div>
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title"> Therapy Info</div>
                        <?php 
                    ?>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 form-group">
                                ...
                                <select class="form-control" name="Gender" id="Gender" value="<?= isset($level) ? $level : '' ?>" placeholder="Gender">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 form-group">
            <label for="Marital">Marital Status</label>
                                <select class="form-control" name="Marital" id="Marital" value="<?= isset($level) ? $level : '' ?>" placeholder="Marital">
                                    <option value="" selected disabled>Select Marital Status </option>
                                    <option value="1" <?= ($gender == '1') ? 'selected' : '' ?>>Married </option>
                                    <option value="2" <?= ($gender == '2') ? 'selected' : '' ?>>Widowed </option>
                                    <option value="3" <?= ($gender == '3') ? 'selected' : '' ?>>Divorced or Separated </option>
                                    <option value="4" <?= ($gender == '4') ? 'selected' : '' ?>>Never Married or Single </option>
                                </select>
                                        </div>
        <div class="col-sm-3 form-group">
