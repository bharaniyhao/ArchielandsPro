                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter Surname  or Name to Search" />
                    ...
                    <div class="col-sm-3 pagination-right">
                       <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('target').value='users'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> Add User </button>
                    </div>
            ...
            <div class="table-responsive">
             ...
             foreach ($rs as $val){
				// $brchname = $engine->getBranch($val['USR_BRCHID']); 
                {
                    ...
                    $status_colors = '';
                    if ($val['USR_LEVEL'] == 1) {
                        $status_leve = 'Administrator';
                        $status_colors = 'success';
                    } elseif ($val['USR_LEVEL'] == 2) {
                        $status_leve = 'Physiotherapist';
                        $status_colors = 'info';
                    } elseif ($val['USR_LEVEL'] == 3) {
                        $status_leve = 'Front Desk Staff';
				...
				<td><span class="badge badge-' . $status_colors . '">' . $status_leve . '</span></td>               

                <td><span class="badge badge-' . $status_color . '">' . $status_name . '</span></td>               
                <td> <div align="center">
                <button type="submit" class="btn btn-success text-white"  role="button" onClick="document.getElementById(\'target\').value=\'edit\';document.getElementById(\'viewpage\').value=\'editmember\';document.getElementById(\'keys\').value=\''.$val['USR_CODE'].'\';document.myform.submit() ">
...
<button type="submit" class="btn btn-danger text-white" role="button" onClick="document.getElementById(\'viewpage\').value=\'deleteuser\';document.getElementById(\'view\').value=\'\';document.getElementById(\'keys\').value=\''.$val['USR_USERID'].'\';document.myform.submit()">
