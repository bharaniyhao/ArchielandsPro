                ...
                <div class="ibox-head">
                    ...
                    ?>
                     <nav aria-label="breadcrumb">
                      ...
                      <button class="btn btn-success text-white" onClick="document.getElementById('target').value='savepatient';document.getElementById('viewpage').value='savepatient';document.myform.submit() "> save </button>
