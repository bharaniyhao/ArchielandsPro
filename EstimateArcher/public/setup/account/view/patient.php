            ...
            <div class="pagination-tab pt-3 pb-3">
                ...
                <div class="table-title d-flex">
                    ...
                    <div class="col-sm-3 pagination-right">
                        <button type="submit" onclick="document.getElementById('action_search').value='';document.getElementById('view').value='patient'; document.getElementById('viewpage').value='';document.myform.submit();" class="btn btn-success btn-square"> <i class="fa fa-user"></i> Add User </button>
                    </div>
             ...
             foreach ($rs as $val){
				// $brchname = $engine->getBranch($val['USR_BRCHID']); {
                    ...
                    echo '<tr>
                        ...
                        <td>
                            <div align="center">
                                <button type="submit" class="btn btn-info text-white" role="button" onClick="document.getElementById(\'target\').value=\'editpatient\';document.getElementById(\'view\').value=\'editpatient\';document.getElementById(\'keys\').value=\''.$val['PatientID'].'\';document.myform.submit()">
