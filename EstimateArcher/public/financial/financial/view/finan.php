...
?>
    ...
    <h1 class="page-title">Financial List </h1>
    <ol class="breadcrumb">
...
<button type="submit" class="btn btn-default btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['transaction_id'] . '\';document.getElementById(\'view\').value = \'details\';document.getElementById(\'viewpage\').value = \'editpatient\';">
                                    <i class="fa fa-eye"></i> View Details
                                </button>

<button type="submit" class="btn btn-default btn-sm btn-danger" data-toggle="tooltip" data-original-title="Edit" onclick="document.getElementById(\'keys\').value = \'' . $val['transaction_id'] . '\';document.getElementById(\'view\').value = \'details\';document.getElementById(\'viewpage\').value = \'editpatient\';">
