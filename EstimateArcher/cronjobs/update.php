...
if ($stmt->RecordCount() > 0) {
    ...
    while ($obj = $stmt->FetchNextObject()) {
        ...
        if ($insertStmt === false) {
            ...
            echo "Booking inserted into BookingRecord for code: " . $code . "<br>";
            ...
            if ($deleteStmt === false) {
                echo "Delete Error for booking code " . $code . ": " . $sql->ErrorMsg() . "<br>";
            } else {
                echo "Booking deleted from Booking table for code: " . $code . "<br>";
            }
        }
    }
} else {
