  ...
  <?php include '../inc/header.php'; ?>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
                        <div class="highlights-section mb60">
                            ...
                            <div class="slide-thumb-gallery">
                                <div class="owl-carousel" data-slider-id="1">
                                    <div><img src="../assets/images/slide_big_1.jpg" alt="" class="img-fluid"></div>
                                    <div><img src="../assets/images/slide_big_2.jpg" alt="" class="img-fluid"></div>
                                    <div><img src="../assets/images/slide_big_3.jpg" alt="" class="img-fluid"></div>
                                    <div><img src="../assets/images/slide_big_4.jpg" alt="" class="img-fluid"></div>
                                </div>
                                <div class="owl-thumbs" data-slider-id="1">
                                    <button class="owl-thumb-item"><img src="../assets/images/slide_small_1.jpg" alt="" class="img-fluid"></button>
                                    <button class="owl-thumb-item"><img src="../assets/images/slide_small_2.jpg" alt="" class="img-fluid"></button>
                                    <button class="owl-thumb-item"><img src="../assets/images/slide_small_3.jpg" alt="" class="img-fluid"></button>
                                    <button class="owl-thumb-item"><img src="../assets/images/slide_small_4.jpg" alt="" class="img-fluid"></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="reviews-section mb60">
                            ...
                            <div class="review-block">
                                <div class="review-img"><img src="../assets/images/user_img_1.jpg" alt="" class="rounded-circle"></div>
                            ...
                            <div class="review-block">
                                <div class="review-img"><img src="../assets/images/user_img_2.jpg" alt="" class="rounded-circle"></div>
                                <div class="review-content">
                            ...
                            <div class="review-block">
                                <div class="review-img"><img src="../assets/images/user_img_3.jpg" alt="" class="rounded-circle"></div>
                                <div class="review-content">
    ...
    <!-- newsletter -->
    <div class="newsletter-wrapper newsletter-overlay" style="background: url(../assets/images/newsletter_wrapper.jpg) no-repeat;">
        <div class="container">
            <div class="row">
