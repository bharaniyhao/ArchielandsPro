...
<html>
<head>
    <title>Welcome to ArchieLand Travel & Tourism</title>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="slider-captions">
                                    <h1 class="slider-title">Get travel Details </h1>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="slider-captions">
                                    <h1 class="slider-title">Travel air Details </h1>
                                    <a href="#" class="btn btn-primary"> Get In Touch </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="slider-captions">
                                    <h1 class="slider-title"> Get tourism Details </h1>
