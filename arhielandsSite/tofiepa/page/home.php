					...
					<div class="property-slider-wrap">
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<a href="index.php?pages=propertyDetails" class="img">
								...
								<div class="property-content">
									...
									<div>
										...
										<span class="city d-block mb-3">Kumasi, USA</span>
										...
										<a href="index.php?action=propertyDetails" class="btn btn-primary py-2 px-3">See details</a>
									</div>
								</div>
							</div> <!-- .item -->
							...
							<div class="property-item">
								...
								<a href="index.php?action=propertyDetails" class="img">
									<img src="images/img_2.jpg" alt="Image" class="img-fluid">
								</a>

								<div class="property-content">
									<div class="price mb-2"><span>$11,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 Kumarica , Ave. 21BC</span>
										<span class="city d-block mb-3">Kumasi, USA</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 ups Fake, Ave. 21BC</span>
										<span class="city d-block mb-3">Accra, USA</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 Malame Fake, Ave. 21BC</span>
										<span class="city d-block mb-3">Accra, USA</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 C25 Fake, Ave. 21BC</span>
										<span class="city d-block mb-3">Tema, GH</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 C8, Ave. 21BC</span>
										<span class="city d-block mb-3">Tema C22, GH</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 Tema, Ave. 21BC</span>
										<span class="city d-block mb-3">Tema C12, GH</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									<div class="price mb-2"><span>$1,291,000</span></div>
									<div>
										<span class="d-block mb-2 text-black-50">5232 Haasto-Atomic, Ave. 21BC</span>
										<span class="city d-block mb-3">Aburi, Ghana</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50">5232 California Fake, Ave. 21BC</span>
										<span class="city d-block mb-3">Medina, GH</span>
				...
				<div class="testimonial-slider">
					<div class="item">
						<div class="testimonial">
							<img src="images/agents/images.png" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
							<div class="rate">
			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/agents/images.png" alt="Image"
						class="img-fluid">
