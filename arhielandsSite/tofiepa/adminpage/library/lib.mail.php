...
class Mail{
    ...
    // public function sendMail($subject, $recipientaddress, $mailcontent, $recipientname, $file_name="", $imagename)
    ...
    public function sendMail($subject, $recipientaddress, $mailcontent, $recipientname, $imagename, $file_name = "") {
        ...
        try { 
            ...
            // $this->mail->isSMTP();
            $this->mail->Host       = 'mail.daakyepension.com';
            $this->mail->SMTPAuth   = true;
            $this->mail->Username   = 'info@daakyepension.com';
            ...
            //Recipients
            $this->mail->setFrom('info@daakyepension.com', 'DaakyePensionTrust');
            $this->mail->addAddress($recipientaddress, $recipientname);
            $this->mail->addReplyTo('info@daakyepension.com', 'DaakyePensionTrust');
