...
<div class="product pt_70 pb_70">
    ...
    <a href="product.php?id=<?php echo $row['p_id']; ?>" class="img">
        <img src="assets/uploads/<?php echo $row['p_featured_photo']; ?>" alt="Product Image" class="img-fluid">
    </a>

    <div class="property-content">
        <div class="price mb-2"><span>$<?php echo $row['p_current_price']; ?></span></div>
        <div>
            <span class="d-block mb-2 text-black-50"><?php echo $row['p_name']; ?></span>
            <span class="city d-block mb-3">
                <?php echo ($row['p_qty'] > 0) ? 'Available Quantity: ' . $row['p_qty'] : 'Out of Stock'; ?>
            </span>
            ...
            <div class="specs d-flex mb-4">
                ...
                <!-- Example: -->
                <span class="d-block d-flex align-items-center">
                    <span class="icon-area me-2"></span>
                    <span class="caption"><?php echo $row['property_area']; ?> sq ft</span>
                </span>
                <!-- Add more details as needed -->
            </div>

            <a href="product.php?id=<?php echo $row['p_id']; ?>" class="btn btn-primary py-2 px-3">See details</a>
        </div>
    </div>
</div>
